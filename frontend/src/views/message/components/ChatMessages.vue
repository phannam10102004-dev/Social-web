      ...
      >
        ...
        >
          ...
          >
            <img
              :src="
                ...
                (message.fileUrl ||
                  (message.file
                    ? $buildAssetUrl('uploads/' + message.file)
                    : ''))
              "
              alt="Image"
          ...
          >
            ...
            <span>{{
              (message && (message.fileName || message.file)) || ""
            }}</span>
          </div>
  ...
  methods: {
    isMyMessage(message) {
      ...
      if (typeof message.isMyMessage === "boolean") {
        console.log(
          `🎯 Using flag - Message "${message.content}" is ${
            message.isMyMessage ? "MINE" : "THEIRS"
          }`
        );
    ...
    getAvatarUrl(avatarPath) {
      ...
      const fullUrl = this.$buildAssetUrl("uploads/user/" + avatarPath);
