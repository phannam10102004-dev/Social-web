  ...
  >
    <div class="notification-avatar">
      ...
      <div class="notification-type-icon" :class="notification.type">
        ...
        <span
          v-if="notification.type === 'like' && notification.reactionType"
    ...
    <div class="notification-content">
      <div class="notification-text">
        <span class="user-name">{{
          notification.fromUser?.displayName || "Hệ thống"
        }}</span>
        <span class="action-text">{{ getActionText(notification.type) }}</span>
        <span v-if="notification.postId" class="post-context"
          >bài viết của bạn</span
        >
      </div>
      ...
      switch (this.notification.type) {
        ...
        case "comment":
          if (this.notification.postId) {
            ...
            const postId =
              typeof this.notification.postId === "object"
